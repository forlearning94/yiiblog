                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="post-thumb">
                                <a href="blog.html"><img src=<?= Yii::getAlias('@web/') . "public/images/blog-grid.jpg" ?> alt="" class="pull-left"></a>
                ...
                <div class="primary-sidebar">
                    ...
                    <aside class="widget">
                        ...
                        <div class="popular-post">
                            ...
                            <a href="#" class="popular-img"><img src=<?= Yii::getAlias('@web/') . "public/images/p1.jpg" ?> alt="">
                        ...
                        <div class="thumb-latest-posts">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><img src=<?= Yii::getAlias('@web/') . "public/images/r-p.jpg" ?> alt="">
